...
// This test checks whether COBOL comment lines that are empty are not written to XML
// by checking whether the XMLWriter class writes it to a file correctly.
public class EmptyCommentXMLTest {
	...
	public void test() {
		...
		String expectedXMLOutput = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"no\"?><cobol/>";
